...
<body>
        ...
        <nav class="navbar navbar-light bg-dark shadow-sm slide-in-left">
          ...
          <a href="specialorder.php" class="mr-3" style="color:#FFF;font-size:50%;letter-spacing:1px;text-transform:uppercase;border-bottom: 1px solid violet"> <i class="fa-solid fa-file fa-2xs mr-1" style="color: #ffffff;"></i>Special Order Files</a>

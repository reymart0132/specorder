...
<body>
  ...
  <nav class="navbar navbar-light bg-dark shadow-sm slide-in-left">
    <a class="navbar-brand" href="https:/ceu.edu.ph/">
      <img src="resource/img/ceuwhite.png" height="70" class="d-inline-block align-top" alt="mdb logo">
      <h3 class="ib">
    </a>
      <a href="specialorder.php" class="mr-3" style="color:#FFF;font-size:50%;letter-spacing:1px;text-transform:uppercase;"> <i class="fa-solid fa-file fa-2xs mr-1" style="color: #ffffff;"></i>Special Order Files</a>
          <a href="formnine.php" class="mr-3" style="color:#FFF;font-size:50%;letter-spacing:1px;text-transform:uppercase"> <i class="fa-solid fa-star fa-2xs mr-1" style="color: #ffffff;"></i>FORM-9</a>
          <a href="gradlist.php" class="mr-3" style="color:#FFF;font-size:50%;letter-spacing:1px;text-transform:uppercase;border-bottom: 1px solid violet"> <i class="fa-solid fa-graduation-cap fa-2xs mr-1" style="color: #ffffff;"></i>Graduation List Files</a>
